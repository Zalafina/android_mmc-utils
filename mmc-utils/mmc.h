...
#define MMC_VENDOR_CMD60            60
#define HEALTH_INFO_CMD_NUMBER      (3)
#define HEALTH_INFO_SIZE            (512)

#define GET_HEALTH_REPORT_ARG_01    (0x534D4900)
#define GET_HEALTH_REPORT_ARG_02    (0x48525054)

#define GET_ERASE_COUNT_ARG_01      (0x534D4900)
#define GET_ERASE_COUNT_ARG_02      (0x45434E54)
